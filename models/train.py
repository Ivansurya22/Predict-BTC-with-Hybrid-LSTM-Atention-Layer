...
class ImprovedTrainer:
    ...
    def fit(self, train_loader, val_loader, epochs=100, patience=15,
            save_dir='models', save_name='lstm'):
...
def main():
    ...
    # Save artifacts
    print(f"\n💾 Saving artifacts...")
    joblib.dump(history, f'{MODEL_DIR}/training_history.pkl')
    joblib.dump(test_results, f'{MODEL_DIR}/test_results.pkl')
    ...
    print(f"\n📁 Saved files:")
    print(f"   Model:   {MODEL_DIR}/lstm_best.pth")
    print(f"   Full:    {MODEL_DIR}/lstm_full.pth")
    print(f"   History: {MODEL_DIR}/training_history.pkl")
    print(f"   Results: {MODEL_DIR}/test_results.pkl")
