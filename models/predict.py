...
class BTCPredictor:
    """
    Bitcoin Price Predictor - FULLY ALIGNED with Balanced Preprocessing

    FIXES APPLIED:
    1. ✅ NaN handling now matches preprocessing exactly (ffill/bfill limit=2, then dropna)
    2. ✅ Added time gap validation (same as preprocessing)
    3. ✅ Better error handling for data quality
    4. ✅ Validation after NaN removal

    Key Features:
    - Loads optimized_features from database (same as preprocessing)
