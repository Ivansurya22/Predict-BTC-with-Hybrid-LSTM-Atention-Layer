...
class BTCTradingBot:
    ...
    async def start_command(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        if is_new_user:
            welcome_msg = (
                ...
                "  ✅ <b>LSTM AI Model</b> - Prediksi harga dengan confidence score\n"
                ...
                "  📊 <b>Latest</b> - Lihat prediksi + confidence terbaru\n"
                ...
                "  • Perhatikan confidence score AI\n"
            ...
            welcome_msg = (
                ...
                "  📊 Latest - Prediksi + confidence terbaru\n"
                "  📈 Chart - Grafik 24h\n"
                "  📉 Stats - Market stats\n"
                "  📜 History - Riwayat\n"
                "  🔔 Alerts - Toggle alert\n"
    ...
    async def help_command(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        help_msg = (
            ...
            "━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n"
            "<b>📱 Bot Commands:</b>\n\n"
            "📊 <b>Latest</b> - Prediksi + confidence terbaru\n"
            "📈 <b>Chart</b> - Grafik harga 24 jam\n"
            "📉 <b>Stats</b> - Statistik market\n"
            "📜 <b>History</b> - Riwayat prediksi\n"
    ...
    async def chart_command(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        try:
            # Generate chart 24 jam
            chart_path = chart_generator.generate_price_chart(hours=24)
    ...
    async def history_command(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        try:
            ...
            for idx, row in df.iterrows():
                ...
                aligned = row['aligned']
                confidence = row['model_confidence'] * 100 if 'model_confidence' in row else 0

                icon = "✅" if aligned else "❌"

                history_msg += (
                    f"{icon} <code>{timestamp[:16]}</code>\n"
                    f"   Model: {model} ({confidence:.1f}%) | SMC: {smc}\n\n"
                )
    ...
    async def alerts_command(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        if new_status:
            msg = (
                ...
                "  • SMC Setup Quality\n"
                "  • Chart 24 jam terakhir\n\n"
                f"📬 Alert dikirim ke chat ID: <code>{chat_id}</code>\n\n"
                "━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n"
        ...
        try:
            if query.data == "chart":
                ...
                if stats:
                    ...
                    # Send new message instead of editing if same content
                    try:
                ...
                if pred_data:
                    ...
                    # Send new message if same content
                    try:
                        await query.edit_message_text(message, parse_mode='HTML', reply_markup=reply_markup)
                    except Exception as edit_error:
                        if "Message is not modified" in str(edit_error):
                            # Send a small notification instead
    ...
    def _format_prediction_message(self, pred_data: dict) -> str:
        """Format prediction data menjadi message dengan confidence"""
        ...
        # SMC section
        smc_conf_bar = self._create_confidence_bar(smc['confidence'] / 100)
        ...
        message = (
            ...
            f"{conf_emoji} Confidence: {model_conf_bar} <b>{model['confidence']*100:.1f}%</b>\n"
